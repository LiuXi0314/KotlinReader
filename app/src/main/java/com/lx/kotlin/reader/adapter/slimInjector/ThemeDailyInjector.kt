 ...
 */
class ThemeDailyInjector(private var context: Context) : SlimInjector<ThemeChildList.StoriesInfo>{
    override fun onInject(data: ThemeChildList.StoriesInfo?, injector: IViewInjector<out IViewInjector<*>>?) {
